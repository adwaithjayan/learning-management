...
const AppSideBar = () => {
  ...
  const currentNavLink = navLinks[userType];

  return (
    <Sidebar
      collapsible="icon"
      style={{ height: "100vh" }}
      className="bg-customgreys-primarybg border-nonr shadow-lg"
    >
      <SidebarHeader>
              ...
              >
                ...
                >
                  <Link href={link.href} className="app-sidebar__nav-link" scroll={false}>
                    <link.icon
                      className={isActive ? "text-white-500" : "text-gray-400"}
                    />
                    <span
                      className={cn(
